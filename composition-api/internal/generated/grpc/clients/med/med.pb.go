...
func (x *UpdateCardOut) Reset() {
	*x = UpdateCardOut{}
	mi := &file_proto_grpc_clients_med_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*UpdateCardOut) Descriptor() ([]byte, []int) {
	return file_proto_grpc_clients_med_proto_rawDescGZIP(), []int{19}
}
...
const file_proto_grpc_clients_med_proto_rawDesc = "" +
	...
	"\x04card\x18d \x01(\v2\x05.CardR\x04card2\x8d\x04\n" +
	"\x06MedSrv\x12;\n" +
...
var file_proto_grpc_clients_med_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
var file_proto_grpc_clients_med_proto_depIdxs = []int32{
	...
	18, // 19: MedSrv.updateCard:input_type -> UpdateCardIn
	20, // 20: MedSrv.registerDoctor:output_type -> google.protobuf.Empty
	3,  // 21: MedSrv.getDoctor:output_type -> GetDoctorOut
	20, // 22: MedSrv.createPatient:output_type -> google.protobuf.Empty
	7,  // 23: MedSrv.getPatient:output_type -> GetPatientOut
	9,  // 24: MedSrv.getPatientsByDoctorID:output_type -> GetPatientsByDoctorIDOut
	11, // 25: MedSrv.updatePatient:output_type -> UpdatePatientOut
	20, // 26: MedSrv.createCard:output_type -> google.protobuf.Empty
	17, // 27: MedSrv.getCard:output_type -> GetCardOut
	17, // 28: MedSrv.getCardByID:output_type -> GetCardOut
	19, // 29: MedSrv.updateCard:output_type -> UpdateCardOut
...
func file_proto_grpc_clients_med_proto_init() {
	...
	file_proto_grpc_clients_med_proto_msgTypes[8].OneofWrappers = []any{}
