...
const (
	...
	MedSrv_GetCardByID_FullMethodName           = "/MedSrv/getCardByID"
	MedSrv_GetCardByUUID_FullMethodName         = "/MedSrv/getCardByUUID"
...
type MedSrvClient interface {
	...
	GetCardByID(ctx context.Context, in *GetCardByIDIn, opts ...grpc.CallOption) (*GetCardOut, error)
	GetCardByUUID(ctx context.Context, in *GetCardByUUIDIn, opts ...grpc.CallOption) (*GetCardOut, error)
...
func (c *medSrvClient) GetCardByID(ctx context.Context, in *GetCardByIDIn, opts ...grpc.CallOption) (*GetCardOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCardOut)
	err := c.cc.Invoke(ctx, MedSrv_GetCardByID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *medSrvClient) GetCardByUUID(ctx context.Context, in *GetCardByUUIDIn, opts ...grpc.CallOption) (*GetCardOut, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCardOut)
	err := c.cc.Invoke(ctx, MedSrv_GetCardByUUID_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MedSrvServer interface {
	...
	GetCardByID(context.Context, *GetCardByIDIn) (*GetCardOut, error)
	GetCardByUUID(context.Context, *GetCardByUUIDIn) (*GetCardOut, error)
...
func (UnimplementedMedSrvServer) GetCardByID(context.Context, *GetCardByIDIn) (*GetCardOut, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCardByID not implemented")
}
func (UnimplementedMedSrvServer) GetCardByUUID(context.Context, *GetCardByUUIDIn) (*GetCardOut, error) {
	return nil, status.Error(codes.Unimplemented, "method GetCardByUUID not implemented")
}
...
func _MedSrv_GetCardByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCardByIDIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MedSrvServer).GetCardByID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MedSrv_GetCardByID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MedSrvServer).GetCardByID(ctx, req.(*GetCardByIDIn))
	}
	return interceptor(ctx, in, info, handler)
}

func _MedSrv_GetCardByUUID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCardByUUIDIn)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MedSrvServer).GetCardByUUID(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: MedSrv_GetCardByUUID_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MedSrvServer).GetCardByUUID(ctx, req.(*GetCardByUUIDIn))
	}
	return interceptor(ctx, in, info, handler)
}
...
var MedSrv_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _MedSrv_GetCardByID_Handler,
		},
		{
			MethodName: "getCardByUUID",
			Handler:    _MedSrv_GetCardByUUID_Handler,
		},
		{
	...
	Metadata: "grpc/clients/med.proto",
}
