			...
			case 'c': // Prefix: "cytology/"
				...
				case 'p': // Prefix: "patient/"
					...
					case '/': // Prefix: "/shots"
						...
						if l := len("/shots"); len(elem) >= l && elem[0:l] == "/shots" {
							elem = elem[l:]
						} else {
							break
						}
						...
						if len(elem) == 0 {
							...
							switch r.Method {
							case "GET":
								s.handleCytologyPatientShotsReadRequest([1]string{
									args[0],
								}, elemIsEscaped, w, r)
							default:
								s.notAllowed(w, r, "GET")
				...
				case 'p': // Prefix: "patient/"
					...
					case '/': // Prefix: "/shots"
						...
						if len(elem) == 0 {
							...
							switch method {
							case "GET":
								r.name = CytologyPatientShotsReadOperation
								r.summary = "получить снимки цитологии пациента"
								r.operationID = "CytologyPatientShotsRead"
								r.pathPattern = "/cytology/patient/{patient_id}/shots"
								r.args = args
								r.count = 1
								return r, true
							default:
