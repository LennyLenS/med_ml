...
func Echographics(echographics domain.Echographic) api.ExamEchographics {
	return api.ExamEchographics{
		ID:              echographics.Id,
...
func SliceEchographics(echographics []domain.Echographic) []api.ExamEchographics {
	result := make([]api.ExamEchographics, 0, len(echographics))
