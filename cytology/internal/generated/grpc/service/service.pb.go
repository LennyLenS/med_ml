...
func (x *GetCytologyImageIdsByDoctorIdAndPatientIdIn) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *GetCytologyImageIdsByDoctorIdAndPatientIdIn) GetPatientId() string {
	if x != nil {
		return x.PatientId
	}
	return ""
...
type GetCytologyImageIdsByDoctorIdAndPatientIdOut struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *GetCytologyImageIdsByDoctorIdAndPatientIdOut) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
const file_proto_grpc_service_proto_rawDesc = "" +
	...
	",GetCytologyImageIdsByDoctorIdAndPatientIdOut\x12\x10\n" +
	"\x03ids\x18d \x03(\tR\x03ids\"\xd5\x04\n" +
