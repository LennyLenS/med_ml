...
type Repository interface {
	...
	GetCytologyImagesByPatientId(patientID uuid.UUID) ([]entity.CytologyImage, error)
	GetCytologyImageIdsByDoctorIdAndPatientId(doctorID, patientID uuid.UUID) ([]uuid.UUID, error)
