...
type UziComplete struct {
	...
	UziS3Path     string                 `protobuf:"bytes,200,opt,name=uzi_s3_path,json=uziS3Path,proto3" json:"uzi_s3_path,omitempty"`
...
func (x *UziComplete) GetUziS3Path() string {
	if x != nil {
		return x.UziS3Path
	}
	return ""
...
const file_proto_dbus_produce_uzicomplete_proto_rawDesc = "" +
	"\n" +
	"$proto/dbus/produce/uzicomplete.proto\"E\n" +
	"\vUziComplete\x12\x15\n" +
	"\x06uzi_id\x18d \x01(\tR\x05uziId\x12\x1f\n" +
	"\vuzi_s3_path\x18\xc8\x01 \x01(\tR\tuziS3PathB-Z+internal/generated/dbus/produce/uzicompleteb\x06proto3"
